...
class TamilSpeechDataset(Dataset):
    """
    A custom PyTorch Dataset for loading Tamil speech data.
    ...
    def __init__(self, root_dir, chars_to_ignore='[\,\?\.\!\-\;\:\"\“\%\‘\”\।\’\']', sampling_rate=16000):
        super(TamilSpeechDataset, self).__init__()
        ...
        for file in audio_files:
            if file.endswith(".wav"):
                ...
                if os.path.exists(trans_file):
                    ...
                    # Clean transcription by removing unwanted characters and converting to lowercase
...
def get_data_loaders(root: str, batch_size: int = 16, num_workers: int = 12, prefetch_factor: int = 2):
    """
    Creates PyTorch DataLoaders for Tamil speech data.
